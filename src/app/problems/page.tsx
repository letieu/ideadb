                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 p-4 sm:p-8">
                  ...
                  <div className="order-1 sm:order-2 flex-1 min-w-0 space-y-3 sm:space-y-4">
                    <div className="space-y-2">
                      <h2 className="text-lg sm:text-xl md:text-2xl font-serif font-semibold tracking-tight text-foreground leading-tight group-hover:text-problem transition-colors">
                          {problem.title}
                      </h2>
