...
// Image metadata
export const alt = 'Problems Database - ideaDB';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          width: 500,
          height: 500,
          background: 'radial-gradient(circle, rgba(255, 77, 77, 0.15) 0%, rgba(5, 8, 16, 0) 70%)',
          borderRadius: '50%',
        }} />
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            Real-world pain points, market gaps, and community-reported challenges.
          </div>
        </div>
      </div>
    ),
