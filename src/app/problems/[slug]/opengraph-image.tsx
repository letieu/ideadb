...
export const alt = 'Problem detail on ideaDB';
export const size = {
  width: 1200,
  height: 630,
};
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, width: '100%' }}>
            ...
            <div style={{ 
              ...
              {problem.description.length > 200 
                ? problem.description.substring(0, 200).replace(/[#*_`]/g, '') + '...' 
                : problem.description.replace(/[#*_`]/g, '')}
            </div>

            <div style={{ display: 'flex', alignItems: 'center', width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                {problem.categories && problem.categories.slice(0, 3).map((cat: any) => (
